                ...
                <Grid
                    ...
                    <Grid item>
                        <Paper elevation={2} style={{
                            ...
                            читают
                            лекции,
                            проводят практические занятия, с клубными учебными крыльями. Мы не коммерческая организация
                            и не
                            зарабатываем на этом денег.
                            Наборы проводятся в конце осени (октябрь-ноябрь). После преобретения начальных навыков,
                            группа
                            молодых пилотов
                            обычно едет в Крым, на Гору Клементьева, совершенствовать свои навыки. Опытные пилоты каждый
                            год
                            организовывают
