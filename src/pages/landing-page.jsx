        ...
        >
            ...
            <Grid item>
                <Paper elevation={2} style={{maxWidth: "20rem", top: "-0.6rem", position: "relative", opacity: "0.8", padding: "1rem"}}>
                    ...
                    Пилоты готовы делиться своим опытом со всеми желающими. Для неопытных пилотов спортсмены читают лекции,
                    ...
                    выезды в разнообразные лётные места России и зарубежья. Пилоты из клуба летали в Крыму, на Кавказе(Пятигорск, Чегем),
